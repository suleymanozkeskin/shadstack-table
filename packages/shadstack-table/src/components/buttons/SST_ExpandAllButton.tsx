...
export interface SST_ExpandAllButtonProps<TData extends SST_RowData> extends React.ComponentProps<
  typeof Button
> {
  table: SST_TableInstance<TData>;
}

export const SST_ExpandAllButton = <TData extends SST_RowData>({
  table,
  ...rest
}: SST_ExpandAllButtonProps<TData>) => {
  const {
