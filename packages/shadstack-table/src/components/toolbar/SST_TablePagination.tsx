...
export interface SST_TablePaginationProps<TData extends SST_RowData> {
  position?: 'bottom' | 'top';
  table: SST_TableInstance<TData>;
}

export const SST_TablePagination = <TData extends SST_RowData>({
  position = 'bottom',
  table,
  ...rest
}: SST_TablePaginationProps<TData>) => {
